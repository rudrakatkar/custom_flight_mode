...
bool px4_msgs__msg__internal_combustion_engine_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // substate
    ...
    assert(PyLong_Check(field));
    ros_message->substate = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // flags
  ...
  {  // pid_idle_rpm_integral
    PyObject * field = PyObject_GetAttrString(_pymsg, "pid_idle_rpm_integral");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->pid_idle_rpm_integral = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
PyObject * px4_msgs__msg__internal_combustion_engine_status__convert_to_py(void * raw_ros_message)
{
  ...
  {  // substate
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->substate);
    {
  ...
  {  // pid_idle_rpm_integral
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->pid_idle_rpm_integral);
    {
      int rc = PyObject_SetAttrString(_pymessage, "pid_idle_rpm_integral", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
