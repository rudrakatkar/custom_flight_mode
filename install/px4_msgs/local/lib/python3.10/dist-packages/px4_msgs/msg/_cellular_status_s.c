...
bool px4_msgs__msg__cellular_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // link_tx_rate
    ...
    assert(PyLong_Check(field));
    ros_message->link_tx_rate = PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // link_rx_rate
    ...
    assert(PyLong_Check(field));
    ros_message->link_rx_rate = PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // cell_tower_id
    PyObject * field = PyObject_GetAttrString(_pymsg, "cell_tower_id");
    if (!field) {
      return false;
    }
    {
      ...
      Py_ssize_t size = 9;
      uint8_t * dest = ros_message->cell_tower_id;
  ...
  {  // band_number
    PyObject * field = PyObject_GetAttrString(_pymsg, "band_number");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->band_number = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // band_frequency
    PyObject * field = PyObject_GetAttrString(_pymsg, "band_frequency");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->band_frequency = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // channel_number
    ...
    assert(PyLong_Check(field));
    ros_message->channel_number = PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // rx_level
    PyObject * field = PyObject_GetAttrString(_pymsg, "rx_level");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->rx_level = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // tx_level
    PyObject * field = PyObject_GetAttrString(_pymsg, "tx_level");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->tx_level = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // rx_quality
    PyObject * field = PyObject_GetAttrString(_pymsg, "rx_quality");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->rx_quality = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // sinr
    ...
    assert(PyFloat_Check(field));
    ros_message->sinr = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
PyObject * px4_msgs__msg__cellular_status__convert_to_py(void * raw_ros_message)
{
  ...
  {  // link_tx_rate
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->link_tx_rate);
    {
      int rc = PyObject_SetAttrString(_pymessage, "link_tx_rate", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // link_rx_rate
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->link_rx_rate);
    {
      int rc = PyObject_SetAttrString(_pymessage, "link_rx_rate", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // cell_tower_id
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "cell_tower_id");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    uint8_t * src = &(ros_message->cell_tower_id[0]);
    memcpy(dst, src, 9 * sizeof(uint8_t));
    Py_DECREF(field);
  }
  {  // band_number
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->band_number);
    {
      int rc = PyObject_SetAttrString(_pymessage, "band_number", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // band_frequency
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->band_frequency);
    {
      int rc = PyObject_SetAttrString(_pymessage, "band_frequency", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // rx_level
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->rx_level);
    {
      int rc = PyObject_SetAttrString(_pymessage, "rx_level", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // tx_level
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->tx_level);
    {
      int rc = PyObject_SetAttrString(_pymessage, "tx_level", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // rx_quality
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->rx_quality);
    {
      int rc = PyObject_SetAttrString(_pymessage, "rx_quality", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
