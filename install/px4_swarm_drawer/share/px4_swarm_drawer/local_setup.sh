...
: ${AMENT_CURRENT_PREFIX:="/home/rudra/custom_flightmode/install/px4_swarm_drawer"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/px4_swarm_drawer/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/px4_swarm_drawer/environment/path.sh"
