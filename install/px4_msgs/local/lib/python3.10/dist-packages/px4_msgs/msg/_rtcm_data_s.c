...
bool px4_msgs__msg__rtcm_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4_msgs.msg._rtcm_data.RtcmData", full_classname_dest, 32) == 0);
  }
  px4_msgs__msg__RtcmData * ros_message = _ros_message;
  {  // timestamp
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * px4_msgs__msg__rtcm_data__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of RtcmData */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4_msgs.msg._rtcm_data");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RtcmData");
  ...
  px4_msgs__msg__RtcmData * ros_message = (px4_msgs__msg__RtcmData *)raw_ros_message;
  {  // timestamp
    PyObject * field = NULL;
